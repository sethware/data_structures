...
class Hashmap():
    ...
    def add(self, key: str, value):
        ...
        hash_code = self.hash(str(key)) % len(self.array)
    ...
    def find(self, key: str=None, value=None):
    ...
    def remove(self, key: str=None, value=None):
        if key is None or value is None:
            raise KeyError('Must provide either a value and a key/hash to Hashmap.remove()')
